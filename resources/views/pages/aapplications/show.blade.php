...
<div class="main-content">
    ...
    <section class="view tables">
        <div class="btns-group-edit"><a class="btn btn-text btn-icon" href="/aapplications"><img src="/icons/back.svg" alt="">Назад</a><a class="btn-edit" href="/aapplications/{{$application->id}}/edit"> 
                        ...
                        <div class="keyValues-wrapper">
                            ...
                            <div class="keyValues-item">
                                <div class="keyValues-name">
                                    <input class="input" id="input_name" type="text" placeholder value="{{$item['input_name']}}" disabled>
                                </div>
