                ...
                <div class="view-item-value">
                    <div class="keyValues keyValues-two">
                        <div class="keyValues-title">
                            ...
                            <div class="keyValues-key keyValues-title-item"><span>Количество</span></div>
                        </div>
                        <div class="keyValues-wrapper">
                            @foreach($needed_ings as $key=>$needing)
                                <div class="keyValues-item">
                                    <div class="keyValues-name">
                                        <input class="input" id="input_name" type="text" value="{{$key}}" disabled>
                                    </div>
                                    <div class="keyValues-key">
                                        <input class="input" id="input_count1" type="text" value="{{-$needing}}" disabled>
                                    </div>
                                </div>
                            @endforeach
                        </div>
